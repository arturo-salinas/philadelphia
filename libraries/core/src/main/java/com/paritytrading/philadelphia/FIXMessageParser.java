...
public class FIXMessageParser {
    ...
    public boolean parse(ByteBuffer buffer) throws IOException {
        ...
        while (true) {
            ...
            if (checkSumEnabled && !checkSum(buffer, beginning, position, length))
                continue;
    ...
    private boolean checkSum(ByteBuffer buffer, int beginning, int position, int length) throws IOException {
